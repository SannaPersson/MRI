...
path='outputs'; % directory to be scanned for data files
...
[seq, ktraj_adc, t_adc, ktraj, t_ktraj, t_excitation, t_refocusing] = def_four_shot();
...
%fov=240e-3; Nx=240; Ny=Nx; % whole-body scanners %rad
fov=256e-3; Nx=96; Ny=Nx; % whole-body scanners %spiral

deltak=1/fov;
deltak = 1 / (2*fov)
os=1; % oversampling factor (we oversample both in image and k-space)
